...
*/
  ...
  Types.ActivePowerPu P2Pu (start = -P20Pu) "Active power on side 2 in p.u (base SnRef) (receptor convention)";
  Types.ReactivePowerPu Q2Pu (start = -Q20Pu) "Reactive power on side 2 in p.u (base SnRef) (receptor convention)";
  Types.VoltageModulePu U2Pu (start = U20Pu) "Voltage on side 2 in p.u (base U2Nom)";
