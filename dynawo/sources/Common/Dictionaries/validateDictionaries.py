...
''')
        ...
        header_file.write("    };\n\n")
        header_file.write("    static const char* const names(const value&); ///< names associated to the enum \n")
        header_file.write("  };\n")
        header_file.write("} //namespace DYN\n")
...
''')
        ...
        cpp_file.write("const char* const Key"+name+"_t::names(const value& v) {\n")
        cpp_file.write("  static const char* const names[] = {\n")
        list_keys = self.keys()
        for key in list_keys:
